...
print2dVector(const vector< vector<Point3f> > &two_d_vector, string vec_name = "vector",
                int debug_level = 2, string print_style = "matlab")
{
    if(DEBUG_ACTIVATE && !debugFileOpen && debug_level <= DEBUG_LEVEL)
    {
        cout << "[ DEBUG] " << vec_name << "\n";
        cout << "[...\n";
    ...
    else if(DEBUG_ACTIVATE && debugFileOpen && debug_level <= DEBUG_LEVEL)
    {
 ...
 */
inline static void
print1dVector(const vector<Point3f> &one_d_vector, string vec_name = "1D Vector",
                int debug_level = 2, string print_style = "matlab")
{
    if(DEBUG_ACTIVATE && !debugFileOpen && debug_level <= DEBUG_LEVEL)
    {
