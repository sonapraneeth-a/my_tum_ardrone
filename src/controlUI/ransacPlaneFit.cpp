...
std::vector<float> ransacPlaneFit(std::vector<std::vector<float> > points, bool verbose)
{
	...
	CMatrixDouble data(3, points.size());
	...
	result.push_back(best_model(0,0));
	result.push_back(best_model(0,1));
	result.push_back(best_model(0,2));
	result.push_back(best_model(0,3));
